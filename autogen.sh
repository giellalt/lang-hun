...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_hun to login script."
...
# the current dir:
if   test x${GTLANG_hun} = x ; then
	echo "WARNING: The variable \${GTLANG_hun} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_hun} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_hun} has the value:"
	echo "  ${GTLANG_hun}"
