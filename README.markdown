...
This directory contains source files for the Hungarian language
...
-   <https://giellalt.uit.no/lang/hun/index.html> (analyser)
...
The Hungarian language sources can be acquired using [giella SVN
